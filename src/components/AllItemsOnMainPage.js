...
const AllItemsOnMainPage = (props) => {
  ...
  let categoryItemToShow = props.props;
  ...
  useEffect(() => {
    setItemsShowen(categoryItemToShow);
  }, [allItems]);
        ...
        <div className="button-instead-of-scrolling">
          ...
          <button
            onClick={() => {
              ...
              setItemsShowen((ItemsShowen0) => allItems.slice(20, 40));
            }}
          >
            1
          </button>
          <button
            onClick={() => {
              setItemsShowen((ItemsShowen0) => allItems.slice(10, 30));
            }}
          >
            2
          </button>
          ...
          <button
            onClick={() => {
              setItemsShowen((ItemsShowen0) => allItems.slice(29, 40));
            }}
          >
            4
          </button>
